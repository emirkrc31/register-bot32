...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag} ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.kadınRol1}>, <@&${ayarlar.kadınRol2}>, <@&${ayarlar.kadınRol3}> rolleri verildi!`)
...
client.channels.cache.get(ayarlar.sohbetKanal).send(`${etiketlenenKişi}, **Aramıza Hoş Geldin! Umarım Eğlenceli Vakit Geçirirsin.**`)
